<form action="action_page.php">
  <div class="container">
    ...
    <input type="text" placeholder="Enter your the  Father name" name="Father" id="Father"  required>
    <br>

    <label for="siter"><b>Father Name</b></label>
    <input type="text" placeholder="Enter your the sister name" name="sister" id="sister"  required>
    <br>
